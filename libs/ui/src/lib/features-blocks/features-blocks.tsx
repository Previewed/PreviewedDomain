// import './features-blocks.module.css';

/* eslint-disable-next-line */
export interface FeaturesBlocksProps {}

export function FeaturesBlocks(props: FeaturesBlocksProps) {
  return (
    <section className="relative w-[100vw] h-auto">
      <div className="max-w-6xl mx-auto w-100 sm:px-20">
        <div className="py-12 md:py-20 border-t border-gray-400">
          {/* Section header */}
          ...
          >
            {/* 1st item */}
            <a
              className="flex flex-col p-5 group text-gray-700 bg-gradient-to-t from-teal-400 to-teal-200 shadow-2xl"
              href="#0"
              data-aos="fade-down"
            ...
            >
              ...
              <div className="text-xl font-extrabold tracking-tighter mb-1">
                Register:
              </div>
              <div className="flex-grow opacity-80 mb-4 text-gray-800">
                Begin your journey to finding your dream job by registering on
                Previewed. It's quick, easy, and completely free. Simply create
                your profile and provide some basic information about your
            ...
            {/* 2nd item */}
            <a
              className="flex flex-col p-5 group text-gray-700 bg-gradient-to-t from-purple-400 to-purple-200 shadow-2xl"
              href="#0"
              data-aos="fade-down"
              data-aos-anchor="[data-aos-id-featbl]"
              data-aos-delay="100"
            >
              ...
              <div className="text-xl font-extrabold tracking-tighter mb-1">
                Watch Matched Day in the Life Video
              </div>
              <div className="flex-grow mb-4 text-gray-800">
                Once registered, our advanced AI algorithm will work its magic
                to match you with your ideal job opportunities. Sit back and
                watch as we present you with immersive "Day in the Life" videos,
                giving you an inside look into your future roles. Get a real
                sense of what it's like to work in your dream job and envision
                yourself thriving in that environment.
              </div>
              <svg
                className="w-6 h-6 self-end transform -translate-x-2 group-hover:translate-x-0 transition duration-150 ease-in-out"
                viewBox="0 0 24 24"
            ...
            {/* 3rd item */}
            <a
              className="flex flex-col p-5 group text-gray-700 bg-gradient-to-t from-indigo-400 to-indigo-200 shadow-2xl"
              href="#0"
              data-aos="fade-down"
              data-aos-anchor="[data-aos-id-featbl]"
              data-aos-delay="200"
            >
              ...
              <div className="text-xl font-extrabold tracking-tighter mb-1">
                Record Your 30-Second CV Video:{' '}
              </div>
              <div className="flex-grow mb-4 text-gray-800">
                Stand out from the crowd and make a lasting impression on
                employers by recording your personalized 30-second CV video.
                Showcase your unique skills, personality, and passion in a
                concise and impactful way. Let your future employers see the
                real you and understand why you're the perfect fit for the job.
              </div>
              <svg
                className="w-6 h-6 self-end transform -translate-x-2 group-hover:translate-x-0 transition duration-150 ease-in-out"
                viewBox="0 0 24 24"
            ...
            {/* 4th item */}
            <a
              className="flex flex-col p-5 group text-gray-700 bg-gradient-to-t from-pink-300 to-pink-100 shadow-2xl"
              href="#0"
              data-aos="fade-down"
              data-aos-anchor="[data-aos-id-featbl]"
              data-aos-delay="300"
            >
              ...
              <div className="flex-grow text-gray-800 mb-4">
                With your profile, matched videos, and 30-second CV in hand,
                you're now ready to land your dream job. Apply directly to the
                positions that excite you, confident that you've already made a
                strong impression. Our platform makes it easy for employers to
                discover your potential and invite you for further interviews
                and assessments.
              </div>
              <svg
                className="w-6 h-6 self-end transform -translate-x-2 group-hover:translate-x-0 transition duration-150 ease-in-out"
...
// const StyledFeaturesBlocks = styled.div`
//   color: pink;
// `;

// export function FeaturesBlocks(props: FeaturesBlocksProps) {
//   return (
//     <StyledFeaturesBlocks>
//       <h1>Welcome to FeaturesBlocks!</h1>
//     </StyledFeaturesBlocks>
//   );
// }
